...
If we were actually using this function, we would want to do many subsamples of cells across conditions to get a sense for the true Bhattacharrya distance. This will be updated soon with a small use cause from scRNAseq data.
